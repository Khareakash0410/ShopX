...
import img1 from "../assets/photo-1512101176959-c557f3516787.avif";
import img2 from "../assets/photo-1568819317551-31051b37f69f.avif"
import img3 from "../assets/Women-Sexy-Lingerie-Police-Uniform-Erotic-Female-Cop-Sheath-Dress-Porn-Policewoman-Role-Play-Costume-Cosplay.webp"

const AboutUs = () => {
  return (
   
<section className="overflow-hidden pt-20 pb-3 lg:pt-[40px] lg:pb-[40px]">
    ...
    <div className="flex flex-wrap items-center justify-between -mx-4">
      ...
      <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
        <div className="mt-10 lg:mt-0">
          <span className="block mb-4 text-xl text-green-400 font-semibold text-primary">
            Why Choose Us
          </span>
          <h2 className="mb-5 text-3xl font-bold text-white sm:text-[40px]/[48px]">
            Make our customers happy by giving products and services.
          </h2>
          <p className="mb-5 text-base text-gray-300">
          Welcome to ShopX, your one-stop destination for a seamless online shopping experience. Whether you're looking for the latest fashion, electronics, home essentials, or more, ShopX brings you a wide range of products at unbeatable prices.
          </p>
          <p className="mb-8 text-base text-gray-300">
          At ShopX, we believe in making online shopping hassle-free, convenient, and affordable for everyone. Join us today and experience shopping like never before!
          </p>
          <Link to={"/"} className="inline-flex items-center justify-center py-3 text-base font-medium text-center text-blue-500 border border-transparent bg-slate-700 rounded-md px-5 bg-primary hover:bg-opacity-70 hover:text-blue-600">
            Get Started
          </Link>
        </div>
      </div>
