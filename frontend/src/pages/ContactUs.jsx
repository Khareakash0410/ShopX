...
import img from "../assets/34461272346_1ff102dd42_z.jpg"
...
const ContactUs = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
          const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/contact-us`, data);
...
<section className="relative z-10 overflow-hidden bg-cover bg-center bg-no-repeat py-8 lg:py-[84px]" style={{ backgroundImage: `url(${img})` }}>
    ...
    <div className="flex flex-wrap -mx-4 lg:justify-between">
      ...
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          <span className="block mb-4 text-green-600 font-semibold text-primary text-xl">
            Contact Us
          </span>
          ...
          "Need help or have a question ? <br />Get in touch with us – we're just a click away!" 🚀💬
          </p>
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              ...
              <p className="text-base text-body-color dark:text-dark-6">
                116, Bhatartpuri Street, Purani Bazar <br /> Karwi, Chitrakoot, Uttar Pradesh, 210205
              </p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              ...
              <p className="text-base text-body-color dark:text-dark-6">
              akashkhare706882@gmail.com
              </p>
              <p className="text-base text-body-color dark:text-dark-6">
              akashkhare201219@gmail.com
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
        ...
        <div className="relative p-8 bg-white opacity-65 rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              <input 
                 ...
                 className="border-stroke disabled:bg-gray-200 disabled:cursor-not-allowed dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none" 
              />
            </div>
            <div className="mb-6">
              <input 
            ...
            <div>
              <button type="submit" className="w-full p-3 text-black bg-green-400 transition border rounded border-primary bg-primary hover:bg-opacity-90">
